...
if ($(".image-box").length > 0) {
  ...
  //     end: "30% top", // The element is 500px hight and end 50px from the top of the viewport
  //     ease: "power2", 
  ...
  const timelineHeader = gsap.timeline({
    scrollTrigger: {
      //id: "ZOOM", // Custom label to the marker
      trigger: "main .content", // What element triggers the scroll
      scrub: 1, // Add a small delay of scrolling and animation. `true` is direct
      invalidateOnRefresh: true,  
      start: "top top", // Start at top of Trigger and at the top of the viewport
      end: "1% top", // The element is 500px hight and end 50px from the top of the viewport
      ease: "power2", 
      //markers: {startColor: "red", endColor: "red", fontSize: "18px", fontWeight: "bold", indent: 320},
      pin: true, // Pin the element true or false
      ...
      let image = container.querySelector("figure"); 
        gsap.to(image, { 
          ...
          scrollTrigger: {
            ...
            end: "bottom 95%", // The element is 500px hight and end 50px from the top of the viewport
            ease: "power2",
        ...
        const playST = ScrollTrigger.create({
          trigger: container, 
          start:'top 95%', 
          //markers: {startColor: "blue", endColor: "blue", fontSize: "15px", fontWeight: "bold"},
          onEnter: () => { 
            anim.play()
          },
          onLeaveBack: () => { 
